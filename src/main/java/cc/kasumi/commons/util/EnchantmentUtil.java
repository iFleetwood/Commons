...
public class EnchantmentUtil {
    ...
    public static Enchantment getByName(String name) {
        Enchantment enchantment = NumberUtil.isInteger(name)
                ? Enchantment.getById(Integer.parseInt(name))
        ...
        if (enchantment == null) {
            enchantment = ALIAS_ENCHANTMENTS.get(name.toLowerCase());
        }

        return enchantment;
    }

    public static void addEnchantmentToItemStack(ItemStack itemStack, Enchantment enchantment, int level) {
    ...
    static {
        ...
        ALIAS_ENCHANTMENTS.put("depth", Enchantment.DEPTH_STRIDER);
        ALIAS_ENCHANTMENTS.put("strider", Enchantment.DEPTH_STRIDER);
    }
}
